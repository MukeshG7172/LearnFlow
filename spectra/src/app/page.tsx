    ...
    <div className="bg-slate-50 grainy-light min-h-screen py-8">
      <section className="container mx-auto px-6 lg:px-12">
        <div className="text-center lg:text-left flex flex-col items-center lg:items-start">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold text-gray-900 tracking-tight mt-16 lg:mt-0">
            Your path for your{" "}
          ...
          <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-gray-600">
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mt-16 text-center lg:text-left">
          Your learning options
        </h2>
        
        <div className="flex justify-center lg:justify-start flex-wrap gap-4 mt-8">
          {["Career", "Job", "Course", "Company"].map((option, index) => (
            <span
              key={index}
              className="text-2xl md:text-3xl lg:text-4xl font-semibold bg-blue-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-700 transition"
            >
              {option}
            </span>
          ))}
        ...
        <ul className="list-disc list-inside text-lg text-gray-700 mt-8 space-y-4 lg:pl-8">
